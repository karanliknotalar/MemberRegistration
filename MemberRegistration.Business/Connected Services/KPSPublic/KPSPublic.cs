...
namespace MemberRegistration.Business.KPSPublic
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="MemberRegistration.Business.KPSPublic.KPSPublicSoap")]
    public interface KPSPublicSoap
    {
        ...
        System.Threading.Tasks.Task<MemberRegistration.Business.KPSPublic.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(MemberRegistration.Business.KPSPublic.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest
    {
        ...
        public MemberRegistration.Business.KPSPublic.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(MemberRegistration.Business.KPSPublic.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse
    {
        ...
        public MemberRegistration.Business.KPSPublic.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(MemberRegistration.Business.KPSPublic.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface KPSPublicSoapChannel : MemberRegistration.Business.KPSPublic.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MemberRegistration.Business.KPSPublic.KPSPublicSoap>, MemberRegistration.Business.KPSPublic.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<MemberRegistration.Business.KPSPublic.TCKimlikNoDogrulaResponse> MemberRegistration.Business.KPSPublic.KPSPublicSoap.TCKimlikNoDogrulaAsync(MemberRegistration.Business.KPSPublic.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<MemberRegistration.Business.KPSPublic.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            MemberRegistration.Business.KPSPublic.TCKimlikNoDogrulaRequest inValue = new MemberRegistration.Business.KPSPublic.TCKimlikNoDogrulaRequest();
            inValue.Body = new MemberRegistration.Business.KPSPublic.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((MemberRegistration.Business.KPSPublic.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
